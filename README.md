...
:root{
  ...
  --img1: url('https://github.com/EstasInvitado/BabyOnWay/blob/main/FONDOhojas.png?raw=true');
...
.monogram::after {
  ...
  background-color: var(--img1);  /* mismo color que el texto */
}
...
.hero-names{
  ...
  font-weight: 1200;
  -webkit-text-stroke: 0.01px #E6DCCB ;  /* delineado */
  color: #6B7566;             /* solo contorno */
...
.section{
  ...
  min-height: 100vh; /* ocupa la pantalla */
}

.section.alt{padding:184px 22px; }

.section.foto1{ background:var(--img1); }

   
.container{  background:var(--img1, 94vw); margin:auto; }
  .secondtext {
  font-family:'Gwendolyn';
...
.sub{
  text-align:center; color:var(--img1);
...
.card-video-wrapper{
  max-width: 420px;     /* tamaño pequeño pero usable */
  width: 100%;
...
.video-section{
  ...
  padding: 80px 0; /* espacio para que el fondo se luzca */
}
.video-text{
  margin-top: 18px;
  text-align: center;
  font-size: 32px;   /* 🔥 aquí lo haces más grande */
  font-weight: 400;
  line-height: 1.2;
}
...
.video-container{
  display: flex;
  flex-direction: column; /* 🔑 esto lo pone abajo */
...
.video-bebe{
  width: 100%;
  max-width: 280px;     /* tamaño del video */
  height: auto;
  border-radius: 16px;
}
...
<header class="hero" id="inicio">
  ...
  <section class="section" id="esperando">
   
      <article class="card reveal">
          <img src="https://github.com/EstasInvitado/BabyOnWay/blob/main/UltrasonidoBebe.png?raw=true" 
       alt="Iglesia" class="card-img">
       <img src="https://github.com/EstasInvitado/BabyOnWay/blob/main/UltrasonidoBebe2.png?raw=true" 
       alt="Iglesia" class="card-img">
       </article>
  ...
  <div class="hero-names">
    Bienvenido bebé<br> <span class="bebe-nombre">GUILLEN</span>
  </div>
  <div class="ornament-abajo"></div>
  <div class="hero-date">Agosto 2026</div>
</div>
...
<!-- PARTE 2 -->
<section class="section video-section" id="video-bebe">
  <div class="video-container">
    <video
      ...
      controls
    >
      <source src="https://github.com/EstasInvitado/BabyOnWay/raw/refs/heads/main/WhatsApp%20Video%202026-01-21%20at%206.28.22%20PM.mp4" type="video/mp4">
    </video>

    <p class="video-text">
      Escucha mis latidos <span class="heart">♥</span>
    </p>
  </div>
</section>
...
const observer = new IntersectionObserver((entries) => {
  ...
  threshold: 0.5 // se reproduce cuando el 50% es visible
});
